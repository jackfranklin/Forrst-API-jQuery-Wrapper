...
Currently two methods are available to you:
...
I suspect this will be documented when the Forrst API is more polished, but for now here's my attempt at explaining it.
